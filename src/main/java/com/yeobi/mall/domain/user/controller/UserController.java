package com.yeobi.mall.domain.user.controller;
...
import com.yeobi.mall.domain.user.dto.UserUpdateRequest;
import com.yeobi.mall.domain.user.service.UserService;
